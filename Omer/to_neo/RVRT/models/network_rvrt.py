...
import sys
sys.path.append('/home/dudy/Nehoray/SHABACK_POC_NEW/Omer/to_neo/RVRT/models')
from ..models.op.deform_attn import deform_attn, DeformAttnPack
...
class RVRT(nn.Module):
    ...
    def forward(self, input_variable):
        ...
        if input_dict.now_training:
            ...
            output = self.test_video(x).to(
                self.train_device)
            self.to(self.train_device)
        return output

    def _forward(self, lqs):
        """Forward function for RVRT.
