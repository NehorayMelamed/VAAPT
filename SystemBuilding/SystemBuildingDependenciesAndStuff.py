...
def find_pt_and_pth_files(directory):
    ...
    for file in pt_and_pth:
        if str(file).startswith("venv") or str(file).startswith("data") or str(file).startswith("output") :
            continue
        else:
...
if __name__ == '__main__':
    ...
    base_project = PARAMETER.BASE_PROJECT
    ...
    # sample_root = "/home/nehoray/PycharmProjects/Shaback/SystemBuilding/directory_root_base_for_pt_and_pth_files"
    #
