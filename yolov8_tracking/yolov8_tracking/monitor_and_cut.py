...
# WEIGHTS = Path("/home/dudy/Nehoray/SHABACK_POC_NEW/object_tracking/git_repos/yolov8_tracking/weights").resolve()
                    ...
                    for j, (output) in enumerate(outputs[i]):
                        ...
                        if save_txt:
                            ...
                            with open(txt_path + '.txt', 'a') as f:
                                f.write(f"{frame_idx + 1} {id} {cls} {bbox_left} {bbox_top} {bbox_w} {bbox_h}\n")
...
#
# def build_plots(video_path_txt, classes, frames_len):
#     ys = [y for y in range(150)]
#     js_output = {
#         "0:": None,
#         "1": None
#     }
#     with open (video_path_txt, "r") as f:
#         list_of_splited_lines = []
#         final_y_list = [0 for _ in range(frames_len)]
#         for line in f.readlines():
#             if line.endswith("\n"):
#                 line = line[:-2]
#             splited_line = line.split(" ")
#             list_of_splited_lines.append(list(splited_line))
#         for line in list_of_splited_lines:
#             current_line_frame_index = line[0]
#             curren_class_number = line[1]
#             js_output[curren_class_number] = final_y_list.insert(current_line_frame_index,final_y_list[current_line_frame_index]+1)
#
#                 # if frames_len == line[0]:
#                 car_counted_list = []
...
def main():
    ...
    # imgsz *= 2 if len(opt.imgsz) == 1 else 1  # expand
    ...
    # run(source, save_txt=True, show_vid=False, tracking_config=tracking_config, tracking_method=tracking_method, save_trajectories=True, save_conf=True)
    source = "/media/dudy/FB31-3461/Downtest_ch0001_00010001837000000.mp4"
    # txt_file = '/home/dudy/Nehoray/SHABACK_POC_NEW/object_tracking/git_repos/yolov8_tracking/runs/track/exp/tracks/video_example_from_security_camera.txt'
    classes = [0]
    run(source, save_txt=True, show_vid=False, tracking_config=tracking_config, tracking_method=tracking_method, save_trajectories=True, save_conf=True, classes=classes)
