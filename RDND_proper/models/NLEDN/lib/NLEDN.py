...
from RDND_proper.models.NLEDN.lib.NEDB import NEDB
from RDND_proper.models.NLEDN.lib.RNEDB import RNEDB
...
class NLEDN(nn.Module):
    def __init__(self, in_channels=3, out_channels=3):
        ...
        self.final_conv = nn.Sequential(
            ...
            nn.Tanh(),  #Why Tanh and not sigmoid??!?!!.....maybe actually this is smarter?....don't know
        )
