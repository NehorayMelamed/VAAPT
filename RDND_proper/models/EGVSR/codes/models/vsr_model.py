...
from RDND_proper.models.EGVSR.codes.models.base_model import BaseModel
from RDND_proper.models.EGVSR.codes.models.networks import define_generator
from RDND_proper.models.EGVSR.codes.models.optim import define_criterion, define_lr_schedule
from RDND_proper.models.EGVSR.codes.utils import net_utils, data_utils
...
class VSRModel(BaseModel):
    ...
    def train(self, data):
        ...
        if self.warp_crit is not None:
            ...
            loss_warp_G = warp_w * self.warp_crit(lr_warp, lr_curr)   #unsupervised loss
            loss_G += loss_warp_G
