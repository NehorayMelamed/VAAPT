...
from RDND_proper.models import define_model
from RDND_proper.models.networks import define_generator
...
if __name__ == '__main__':
    ...
    from RDND_proper.models.networks.tecogan_nets import FNet, SRNet
