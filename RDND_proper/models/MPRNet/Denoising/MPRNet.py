...
class SAM(nn.Module):
    def __init__(self, in_channels, n_feat, kernel_size, bias):
        super(SAM, self).__init__()
        self.conv1 = conv(n_feat, n_feat, kernel_size, bias=bias)
        # self.conv2 = conv(n_feat, 3, kernel_size, bias=bias)
        # self.conv3 = conv(3, n_feat, kernel_size, bias=bias)
        self.conv2 = conv(n_feat, in_channels, kernel_size, bias=bias)
        self.conv3 = conv(in_channels, n_feat, kernel_size, bias=bias)
...
class MPRNet(nn.Module):
    def __init__(self, in_c=3, out_c=3, n_feat=80, scale_unetfeats=48, scale_orsnetfeats=32, num_cab=8, kernel_size=3, reduction=4, bias=False):
        ...
        self.sam12 = SAM(in_c, n_feat, kernel_size=1, bias=bias)
        self.sam23 = SAM(in_c, n_feat, kernel_size=1, bias=bias)
