import argparse
import models.RIDNet.TestCode.code.template as template
...
parser.add_argument('--data_test', type=str, default='CBSD68',
                    help='test dataset name')
parser.add_argument('--benchmark_noise', action='store_true',
                    help='use noisy benchmark sets')
parser.add_argument('--n_train', type=int, default=1989,
                    help='number of training set')
parser.add_argument('--n_val', type=int, default=105,
                    help='number of validation set')
parser.add_argument('--offset_val', type=int, default=1989,
                    help='validation index offest')
parser.add_argument('--ext', type=str, default='sep_reset',
                    help='dataset file extension')
parser.add_argument('--noise_g', default='25',
                    help='Gaussian Noise')
...
parser.add_argument('--model', default='RIDNET',
                    help='model name')
