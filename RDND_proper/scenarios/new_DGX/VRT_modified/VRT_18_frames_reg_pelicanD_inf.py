...
# model_denoise_path = osp.join('/raid/old_checkpoints', 'Thermal_video_train.py/Thermal_video_train.py_TEST1_Step8700.tar')
model_denoise_path = '/raid/Pytorch_Checkpoints/2022-06-26/Model_New_Checkpoints/VRT_18_frames_reg_pelicanD_train.py/VRT_18_frames_reg_pelicanD_train.py_TEST1_Step7275.tar'
...
# model_denoise_path = '/raid/Pytorch_Checkpoints/2022-06-26/Model_New_Checkpoints/VRT_18_frames_denoise_dudy_specs_for_rosh_mop_vrt_dudy.py(harder_reg)/VRT_18_frames_reg_pelicanD_train.py_TEST1_Step7275.tar'

#(2). Train Images:
Train_Images_Folder = osp.join(datasets_main_folder, 'night/fixed_images')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'night/fixed_images')
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_better_concat'
...
IO_dict_test.number_of_image_frames_to_generate = 210
IO_dict_test.number_of_images_per_video_to_load = 210
#######################################################################################################################################
