...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_denoise_dudy
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '(harder_reg)'
...
IO_dict.noise_dict.PRNU_sigmas_polynomial_params = [(3*temp_factor,10*temp_factor)]
IO_dict.noise_dict.RURNU_sigmas_polynomial_params = [(3*temp_factor,10*temp_factor)]
IO_dict.noise_dict.CRN_sigmas_polynomial_params = [(3*temp_factor,10*temp_factor)]

IO_dict.noise_dict.per_pixel_readout_noise_sigma = (5*temp_factor,20*temp_factor)
IO_dict.noise_dict.row_readout_noise_sigma = (3*temp_factor,10*temp_factor)
IO_dict.noise_dict.col_readout_noise_sigma = (3*temp_factor,10*temp_factor)
...
IO_dict.noise_dict.flag_add_blob_NU = True

IO_dict.noises_flags = []
# Model Noises
IO_dict.noise_dict.flag_add_per_pixel_readout_noise = True # 1)
IO_dict.noise_dict.flag_add_row_readout_noise = True # 2)
IO_dict.noise_dict.flag_add_col_readout_noise = True # 3)
...
IO_dict.noises_flags.extend([IO_dict.noise_dict.flag_add_per_pixel_NU] * len(IO_dict.noise_dict.PRNU_sigmas_polynomial_params[0]))
if len(IO_dict.noise_dict.PRNU_sigmas_polynomial_params[0])==1:
    IO_dict.noises_flags.append(False)
IO_dict.noises_flags.extend([IO_dict.noise_dict.flag_add_row_NU] * len(IO_dict.noise_dict.RRNU_sigmas_polynomial_params[0]))
if len(IO_dict.noise_dict.RRNU_sigmas_polynomial_params[0])==1:
    IO_dict.noises_flags.append(False)
IO_dict.noises_flags.extend([IO_dict.noise_dict.flag_add_col_NU] * len(IO_dict.noise_dict.CRNU_sigmas_polynomial_params[0]))
if len(IO_dict.noise_dict.CRNU_sigmas_polynomial_params[0])==1:
    IO_dict.noises_flags.append(False)
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_dudy(True, checkpoint_path=model_denoise_path, train_device=train_devices[0],
                                       test_device=test_devices[0], test_args=IO_dict.test_args, noises_flags=IO_dict.noises_flags, use_conf=False)
