...
model_sr_path = osp.join(base_path, 'Checkpoints/VRT/001_VRT_videosr_bi_REDS_6frames.pth')
model_sr_path = '/raid/Pytorch_Checkpoints/2022-06-12/Model_New_Checkpoints/drones_SR.py/drones_SR.py_TEST1_Step34425.tar'
...
IO_dict.test_args = TestArgs(tile=[12,64,64], nonblind_denoising=False, scale=4)
### Loading Images: ###
#(1). Folder names:
#(1.1). Root Folder:
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_SR_6_frames_checkpoint(False, checkpoint_path=model_sr_path, train_device=train_devices[0],
