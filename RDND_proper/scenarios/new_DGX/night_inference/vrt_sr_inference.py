...
model_sr_path = '/raid/Pytorch_Checkpoints/2022-06-12/Model_New_Checkpoints/drones_SR_noised.py/drones_SR_noised.py_TEST1_Step8850.tar'

#(2). Train Images:
Train_Images_Folder = osp.join(datasets_main_folder, 'night/images')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'night/images')
...
IO_dict.test_args = TestArgs(tile=[20,160,160], nonblind_denoising=False, scale=4)
