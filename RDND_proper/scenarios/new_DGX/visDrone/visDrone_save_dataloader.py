...
#(2). Train Images:
Train_Images_Folder = osp.join(datasets_main_folder, 'binning_datasets/VisDrone/sequences')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'binning_datasets/VisDrone/sequences')
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + 'X8_harder'
...
w,h,offset = 1080,1920, 0# 176,320,0# 12,512,0 128, 240
...
IO_dict_test.number_of_image_frames_to_generate = 30
IO_dict_test.number_of_images_per_video_to_load = 30
#######################################################################################################################################
