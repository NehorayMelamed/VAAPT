...
#(2). Train Images:
Train_Images_Folder = osp.join(datasets_main_folder, 'binning_datasets/VisDroneX2')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'binning_datasets/VisDroneX2')
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_SR_6_frames_checkpoint_img_sz_160(True, checkpoint_path=model_sr_path, train_device=train_devices[0],
