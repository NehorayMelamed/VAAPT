...
#(2). Train Images:
Train_Images_Folder = osp.join(datasets_main_folder, 'binning_datasets/visdrone_train')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'binning_datasets/visdrone_test')
