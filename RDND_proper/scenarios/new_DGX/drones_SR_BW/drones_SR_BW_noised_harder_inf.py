...
model_deblur_path = '/raid/Pytorch_Checkpoints/2022-05-31/Model_New_Checkpoints/drones_SR_BW_noised_harder.py/drones_SR_BW_noised_harder.py_TEST1_Step9750.tar'
...
model_sr_path = '/raid/Pytorch_Checkpoints/2022-06-26/Model_New_Checkpoints/drones_SR_BW_noised_harder.py/drones_SR_BW_noised_harder.py_TEST1_Step9750.tar'
...
IO_dict.test_args = TestArgs(tile=[18,256,256], nonblind_denoising=False, scale=4)
