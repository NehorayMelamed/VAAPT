...
# model_sr_path = '/raid/Pytorch_Checkpoints/2022-09-14/Model_New_Checkpoints/drones_SR_BW[160,160].py/drones_SR_BW[160,160].py_TEST1_Step59400.tar'
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) +'_3_fixed_loss'
...
# Loss_object = RapidBase.TrainingCore.losses.Loss_grad_VRT(inputs_dict=None)
