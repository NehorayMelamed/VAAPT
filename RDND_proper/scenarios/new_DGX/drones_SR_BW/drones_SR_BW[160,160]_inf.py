...
model_sr_path = '/raid/Pytorch_Checkpoints/2022-06-26/Model_New_Checkpoints/drones_SR_BW[160,160].py/drones_SR_BW[160,160].py_TEST1_Step10275.tar'
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_try2'
