...
#(2). Train Images:
Train_Images_Folder = osp.join(datasets_main_folder, 'vrt_third/sharp_deblur_25_7/')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'vrt_third/sharp_deblur_25_7/')
...
IO_dict.GT_string_pattern_to_search = '*GT_X4*'
