...
model_denoise_path = '/raid/Pytorch_Checkpoints/2022-06-26/Model_New_Checkpoints/VRT_18_frames_denoise_dudy_specs_for_rosh_mop.py(harder_reg)' \
                '/VRT_18_frames_denoise_dudy_specs_for_rosh_mop.py(harder_reg)_TEST1_Step30075.tar'
model_checkpoints = [model_denoise_path, model_deblur_path]

#(2). Train Images:
Train_Images_Folder = osp.join(datasets_main_folder, 'ThirdEye')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'ThirdEye')
...
IO_dict.Corrupted_string_pattern_to_search = '*X1_fixed_images*'
IO_dict.GT_string_pattern_to_search = '*X1_fixed_images*'
