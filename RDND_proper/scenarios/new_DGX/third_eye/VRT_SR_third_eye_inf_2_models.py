...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_denoise_SR
...
model_sr_path = '/raid/Pytorch_Checkpoints/2022-08-28/Model_New_Checkpoints/' \
                'VRT_SR_denoise-deblur_third_eye_2_models.py/VRT_SR_denoise-deblur_third_eye_2_models.py' \
                '_TEST1_Step9600.tar'
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_SRmodel = VRT_denoise_SR(checkpoints=model_checkpoints, train_devices=train_devices,
                                             test_devices=test_devices, all_pretrained=True)
