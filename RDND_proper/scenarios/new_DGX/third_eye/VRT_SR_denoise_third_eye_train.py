...
#                 'VRT_SR_denoise_third_eye_train.py_grad_loss_2_p=0.5/VRT_SR_denoise_third_eye_train.py_grad_loss_2_p=0.5_TEST1_Step5625.tar'
model_sr_path = '/raid/Pytorch_Checkpoints/2022-09-14/Model_New_Checkpoints/' \
                'drones_SR_BW[160,160].py/drones_SR_BW[160,160].py_TEST1_Step59250.tar'
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_grad_loss_6_p=0.25_2_models_sr_denoise_frozen-sr_fixed_ranges'
# Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + 'L1_loss_2_models_sr_denoise'
...
IO_dict.PPP = [10,20] #[2, 10]  # Photons per Pixel.
### Noise Addition: ###
temp_factor = 12/255
...
grad_function_num = 6
p = 0.25
Loss_object = RapidBase.TrainingCore.losses.Loss_grad_VRT(inputs_dict=None, grad_function_num=grad_function_num, p=p)
