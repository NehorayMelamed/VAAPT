...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_NU_ranges'
...
IO_dict.test_args = TestArgs(tile=[36,192,192], nonblind_denoising=True)
...
IO_dict.PPP = [4,6]  # Photons per Pixel.
### Noise Addition: ###
temp_factor = 55/255
IO_dict.blur_range = True
IO_dict.noise_dict = get_default_noise_dict()

IO_dict.noise_dict.PRNU_sigmas_polynomial_params = [(0, 3*temp_factor)]
IO_dict.noise_dict.RRNU_sigmas_polynomial_params = [(0, 3*temp_factor)]
IO_dict.noise_dict.CRNU_sigmas_polynomial_params = [(0, 3*temp_factor)]
...
IO_dict.transforms_dict.blur_fraction = 1
...
IO_dict.transforms_dict.number_of_blur_steps_per_pixel = 4
### Super Resolution: ###
...
w,h,offset = 192,192,16 # 12,512,0
...
w,h,offset = 512,512,16 # 12,512,0
...
IO_dict_test.number_of_image_frames_to_generate = 12 * 3
IO_dict_test.number_of_images_per_video_to_load = 12 * 3
#######################################################################################################################################
