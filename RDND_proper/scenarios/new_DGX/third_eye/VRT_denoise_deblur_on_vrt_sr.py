...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_SR_6_frames_checkpoint, VRT_SR_6_frames_checkpoint_img_sz_160, VRT_denoise_6_frames_checkpoint
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) +'_work_forreal'
...
IO_dict.test_args = TestArgs(tile=[36,192,192], nonblind_denoising=True, scale=1)
