...
#                 'VRT_SR_denoise-deblur_third_eye[pretrained].py/VRT_SR_denoise-deblur_third_eye[pretrained].py' \
#                 '_TEST1_Step13200.tar'
# model_sr_path = '/raid/Pytorch_Checkpoints/2022-08-29/Model_New_Checkpoints/' \
#                 'VRT_SR_denoise-deblur_third_eye[pretrained].py-higher_ppp_more_sigma/VRT_SR_denoise-deblur_third_eye[pretrained].py-higher_ppp_more_sigma' \
#                 '_TEST1_Step13200.tar'
# model_sr_path = '/raid/Pytorch_Checkpoints/2022-08-29/Model_New_Checkpoints/' \
...
# '_TEST1_Step12300.tar'

# model_sr_path = '/raid/Pytorch_Checkpoints/2022-08-29/Model_New_Checkpoints/' \
# 'VRT_SR_denoise-deblur_third_eye[pretrained]_18f.py/VRT_SR_denoise-deblur_third_eye[pretrained]_18f.py' \
# '_TEST1_Step12450.tar'
#
# model_sr_path = '/raid/Pytorch_Checkpoints/2022-09-07/Model_New_Checkpoints/' \
# 'VRT_SR_denoise-deblur_third_eye.py/VRT_SR_denoise-deblur_third_eye.py' \
# '_TEST1_Step57900.tar'
# model_sr_path = '/raid/Pytorch_Checkpoints/2022-09-13/Model_New_Checkpoints/' \
# 'VRT_SR_denoise_third_eye_train.py_grad_loss_2_p=0.5/VRT_SR_denoise_third_eye_train.py_grad_loss_2_p=0.5' \
# '_TEST1_Step5625.tar'
# model_sr_path = '/raid/Pytorch_Checkpoints/2022-09-12/Model_New_Checkpoints/drones_SR_BW[160,160].py/drones_SR_BW[160,160].py_TEST1_Step15150.tar'
# model_sr_path = '/raid/Pytorch_Checkpoints/2022-09-14/Model_New_Checkpoints/drones_SR_BW[160,160].py/drones_SR_BW[160,160].py_TEST1_Step59250.tar'  # Best model
# model_sr_path = '/raid/Pytorch_Checkpoints/2022-09-18/Model_New_Checkpoints/VRT_SR_denoise_third_eye_train.py_grad_loss_6_p=0.5_fixed_ranges/VRT_SR_denoise_third_eye_train.py_grad_loss_6_p=0.5_fixed_ranges_TEST1_Step7725.tar'
# model_sr_path = '/raid/Pytorch_Checkpoints/2022-09-19/Model_New_Checkpoints/SR_denoise_FFT_loss_2.py/' \
#                 'SR_denoise_FFT_loss_2.py_TEST1_Step6600.tar'
model_sr_path = '/raid/Pytorch_Checkpoints/2022-09-19/Model_New_Checkpoints/SR_denoise_FFT_loss_1.py/' \
                'SR_denoise_FFT_loss_1.py_TEST1_Step6600.tar'
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + 'FFT_loss1'
