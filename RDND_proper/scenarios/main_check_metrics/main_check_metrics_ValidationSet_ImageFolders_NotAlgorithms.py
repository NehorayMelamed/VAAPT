...
original_images_path = os.path.join(datasets_main_folder, '/DataSets/Div2K/Shifted_Images_Blur/Div2k_validation_set_BW_video/Shift_20/PSNR_inf')
noisy_images_path = os.path.join(datasets_main_folder, '/DataSets/Div2K/Shifted_Images/Div2k_validation_set_BW_video/Shift_20/PSNR_5')
clean_images_path = os.path.join(datasets_main_folder, '/DataSets/Div2K/Shifted_Images/Div2k_validation_set_BW_video/Shift_20/PSNR_5')
###
...
noisy_images, noisy_image_filenames = read_images_and_filenames_from_folder(noisy_images_path,
                                      ...
                                      flag_to_BW=False,
                                      flag_random_first_frame=False)
clean_images, clean_image_filenames = read_images_and_filenames_from_folder(clean_images_path,
                                      flag_recursive=True,
                                      crop_size=np.inf,
                                      max_number_of_images=np.inf,
                                      allowed_extentions=IMG_EXTENSIONS,
