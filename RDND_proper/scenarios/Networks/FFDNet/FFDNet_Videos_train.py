...
#####################################################################################################################################################################
### Model Itself: ###
# model = FFDNet_dudy2(in_nc=1, out_nc=1, nc=64, nb=15, act_mode=['D3'])
# model = FFDNet_dudy(in_nc=1, out_nc=1, nc=64, nb=15, act_mode='BL')
model = FFDNet_dudy_Residual(in_nc=1, out_nc=1, nc=64, nb=15, act_mode='BL')
