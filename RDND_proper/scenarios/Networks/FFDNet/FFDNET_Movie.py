...
from RDND_proper.models.KAIR_FFDNet_and_more.models.network_ffdnet import *
...
Original_Images_Folder = Train_Images_Folder
...
# Train_dict.Network_checkpoint_prefix = 'FFDNet2_1Image_Videos_D3_1'
Train_dict.Network_checkpoint_prefix = 'FFDNetOriginal_Residual_1Image_Videos_BL_2'
...
### Load Network: ###
#######################
# Train_dict.load_Network_filename = r'/home/mafat/PycharmProjects/IMOD/models/KAIR_FFDNet_and_more/model_zoo/ffdnet_gray.pth'
# Train_dict.load_Network_filename = r'FFDNET_BW_1_TEST1_Step129400.tar'
Train_dict.load_Network_filename = r'FFDNET_BW_1_TEST1_Step129400.tar'
Train_dict.load_Network_filename = r'FFDNET_BW_Residual_1_TEST1_Step232800.tar'
# Train_dict.load_Network_filename = r'ffdnet_gray_TEST1_Step50.tar'
# Train_dict.load_Network_filename = r'ffdnet_gray_TEST1_Step100.tar.xz'
######################################################################################################################
...
####################################
### DataSets: ###
train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AddNoise(Train_Images_Folder, Train_dict=IO_dict)
test_dataset = TrainingCore.datasets.DataSet_SingleVideo_RollingIndex_AddNoise(root_folder=Test_Images_Folder, Train_dict=IO_dict)
original_dataset = TrainingCore.datasets.DataSet_SingleVideo_RollingIndex_AddNoise(root_folder=Original_Images_Folder, Train_dict=IO_dict)
### DataLoaders: ###
...
#####################################################################################################################################################################
### Model Itself: ###
# model = FFDNet(in_nc=5, out_nc=1, nc=64, nb=15, act_mode='R')
model = FFDNet_dudy2(in_nc=5, out_nc=1, nc=64, nb=15, act_mode='R')
...
preprocessing_object = PreProcessing_FFDNet()
postprocessing_object = PostProcessing_Base()
#####################################################################################################################################################################
