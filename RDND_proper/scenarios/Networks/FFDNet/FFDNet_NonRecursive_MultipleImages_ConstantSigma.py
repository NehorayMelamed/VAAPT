...
Train_dict.Network_checkpoint_prefix = 'FFDNetOld_MultipleImages_Shift2_NonRecursive_ConstantSigma_SingleNoiseLevel_BN'
...
Train_dict.network_free_flow_description = 'mean gray level=5'
######################################################################################################################
...
####################################
### DataSets: ###
train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_Shifts_AddExternalNoiseImage(Train_Images_Folder, Camera_Noise_Folder,  IO_dict)
test_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_Shifts_AddExternalNoiseImage(Test_Images_Folder, Camera_Noise_Folder, IO_dict_test)
...
model = FFDNet_dudy(in_nc=5, out_nc=1, nc=64, nb=15, act_mode='BL')
...
postprocessing_object = PostProcessing_FFDNet()
...
### Get Debug Callback: ###
debug_callback = TrainingCore.callbacks.InferenceCallback_Denoising_Base(inference_path + '_debug', Train_dict)  #TODO: isn't the Train_dict.is_training useless now?!!
### Get Validation Callback: ###
validation_callback = TrainingCore.callbacks.InferenceCallback_Denoising_Base(inference_path + '_validation', Train_dict)
