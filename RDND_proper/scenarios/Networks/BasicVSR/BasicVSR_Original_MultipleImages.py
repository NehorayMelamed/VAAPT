...
from RDND_proper.models.BasicSRVSR.basicsr.archs.basicvsr_arch import BasicVSR
...
Train_dict.Network_checkpoint_prefix = 'BasicVSR_MultipleImages_SimpleFF'
...
#####################################################################################################################################################################
### Model Itself: ###
model = BasicVSR(num_feat=64, num_block=15)
