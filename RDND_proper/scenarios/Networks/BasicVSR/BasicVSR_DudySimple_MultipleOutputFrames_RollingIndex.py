...
from RDND_proper.models.BasicSRVSR.basicsr.archs.basicvsr_arch import BasicVSR, BasicVSR_SimpleFFX2_1, BasicVSR_SimpleFFX2_MultipleOutputImages_1, BasicVSR_SimpleRecurrent_1, BasicVSR_SimpleRecurrent_BiDirectional_1
...
Train_dict.Network_checkpoint_prefix = 'BasivVSR_MultipleImages_SimpleFFX2_MultipleOutputs'
...
IO_dict.movie_frame_to_start_from = 5 #TODO: add "skip frames" or something
### Miscellenous: ###
...
IO_dict_test.initial_crop_size = [512,512]
IO_dict_test.final_crop_size = [512,512]
...
#####################################################################################################################################################################
### Model Itself: ###
model = BasicVSR_SimpleFFX2_MultipleOutputImages_1(number_of_input_channels=1, number_of_input_frames=5, number_of_output_channels=1, num_feat=64, num_block=15,
...
preprocessing_object.flag_RGB2BW = True
preprocessing_object.flag_movie_inference = Train_dict.flag_movie_inference  #this flag is to tell the preprocessing object to normalize each step
...
### Get Debug Callback: ###
debug_callback = InferenceCallback_Movie(inference_path + '_debug', Train_dict)  #TODO: isn't the Train_dict.is_training useless now?!!
