...
from RDND_proper.models.Classic_IIR.Classic_IIR import Classic_IIR_alpha_blend, Classic_IIR_1
...
Train_dict.Network_checkpoint_prefix = 'Classic_IIR'
...
Train_dict.network_free_flow_description = 'Classic IIR trying to get reset gate from NN, loss every frame and next frame uses CLASSICAL output'
######################################################################################################################
...
### Load Network: ###
#######################
Train_dict.load_Network_filename = path_fix_path_for_linux(r'')
######################################################################################################################
...
IO_dict.mean_gray_level_per_pixel = [5, 5]
...
### Quantization: ###
IO_dict.flag_quantize_frames = False
### Cropping: ###
...
####################################
### DataSets: ###
train_dataset = TrainingCore.datasets.DataSet_Videos_In_Folders_AddNoise(Train_Images_Folder, IO_dict=IO_dict)
# train_dataset = TrainingCore.datasets.DataSet_Videos_In_Folders_SuperResolution_DownSampleOnTheFly(Train_Images_Folder, IO_dict=IO_dict)
# train_dataset = TrainingCore.datasets.DataSet_Videos_In_Folders_AddExernalNoise(Train_Images_Folder, IO_dict=IO_dict)
# train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AWGNNoise_BlurLowPass(Train_Images_Folder, IO_dict=IO_dict)
# train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage(Train_Images_Folder, IO_dict=IO_dict)
# train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AWGNNoise_Shifts_SuperResolution_LoadLRHR_1(Train_Images_Folder, IO_dict=IO_dict)
# train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AWGNNoise_Shifts_SuperResolution_DownSampleOnTheFly(Train_Images_Folder, IO_dict=IO_dict)
# train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_Shifts_AddExternalNoiseImage(Train_Images_Folder, IO_dict=IO_dict)
# test_dataset = TrainingCore.datasets.DataSet_Videos_In_Folders_AddNoise(Test_Images_Folder, IO_dict=IO_dict_test)
test_dataset = TrainingCore.datasets.DataSet_SingleVideo_RollingIndex_AddNoise(root_folder=Test_Images_Folder, IO_dict=IO_dict)
### DataLoaders: ###
...
data_from_dataloader = train_dataset[0]
...
#####################################################################################################################################################################
### Model Itself: ###
model = Classic_IIR_1(IO_dict, in_channels=6, out_channels=1)
...
preprocessing_object = PreProcessing_ClassicIIR()
postprocessing_object = PostProcessing_ClassicIIR()
#####################################################################################################################################################################
