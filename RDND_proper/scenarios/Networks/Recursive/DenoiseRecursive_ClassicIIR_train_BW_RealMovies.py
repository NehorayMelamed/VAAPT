...
from RapidBase.TrainingCore.pre_post_callbacks import PostProcessing_Base, PostProcessing_ClassicIIR, PreProcessing_ClassicIIR, PostProcessing_ClassicIIR_AlphaBlend
...
Train_Images_Folder = os.path.join(datasets_main_folder, '/Example Videos/LWIR_video_inf')
# Test_Images_Folder = os.path.join(datasets_main_folder, '/DataSets\Div2K\DIV2K_train_HR_BW')
Test_Images_Folder = os.path.join(datasets_main_folder, '/Example Videos/LWIR_video_inf')
...
Train_dict.number_of_validation_samples = np.inf
...
### Time Parametrs: ###
Train_dict.number_of_total_backward_steps_per_image = 25 #number of backward steps before changing images batch
Train_dict.number_of_time_steps_in_one_backward = 1 #number of time steps before doing a .backward()
...
Train_dict.flag_learn_clean_or_running_average = 'clean' #'running_average', 'clean'
###
######################################################################################################################
...
Network_save_load_dict.Network_checkpoint_prefix = 'ClassicIIR_1'
Network_save_load_dict.Network_checkpoint_prefix = 'ClassicIIR_Gradient_Movie_1'
...
Network_save_load_dict.network_free_flow_description = 'classicIIR'
######################################################################################################################
...
Network_save_load_dict.main_file_to_save_for_later = __file__
...
### Cropping: ###
IO_dict.initial_crop_size = [128*2+10,128*2+10]
...
IO_dict_test.initial_crop_size = [128*4,128*4]
IO_dict_test.final_crop_size = [128*4,128*4]
#######################################################################################################################################
...
validation_callback = TrainingCore.callbacks.InferenceCallback_ExampleFolder_Recursive_ClassicIIR(inference_path, Train_dict.is_training)
