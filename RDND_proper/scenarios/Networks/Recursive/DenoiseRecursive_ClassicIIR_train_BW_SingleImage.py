...
Train_dict.flag_learn_clean_or_running_average = 'clean'
# Train_dict.flag_learn_clean_or_running_average = 'running_average'
###
######################################################################################################################
...
train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AddNoise(Train_Images_Folder,
                                                                    ...
                                                                    crop_size=128*2,
                                                                    flag_to_RAM=True, flag_recursive=False,
                                                                    flag_normalize_by_255=False,
                                                                    flag_crop_mode='random',
...
test_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AddNoise(Test_Images_Folder,
                                                                    ...
                                                                    crop_size=128*4,
                                                                    flag_to_RAM=False, flag_recursive=False,
                                                                    flag_normalize_by_255=False,
                                                                    flag_crop_mode='random',
