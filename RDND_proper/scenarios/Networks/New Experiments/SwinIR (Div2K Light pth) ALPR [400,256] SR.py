...
Train_dict.Network_checkpoint_prefix = 'SwinIR (Divk2K Light pth) ALPR [400,256] SR'
...
model_path = os.path.join(base_path,'Pretrained Checkpoints/SwinIR/002_lightweightSR_DIV2K_s64w8_SwinIR-S_x4.pth')
