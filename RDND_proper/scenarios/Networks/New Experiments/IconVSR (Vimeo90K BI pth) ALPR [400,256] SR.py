...
Train_dict.Network_checkpoint_prefix = 'IconVSR (Vimeo90K BI pth) ALPR [400,256] SR'
...
model_path_iconvsr = os.path.join(base_path,'Pretrained Checkpoints/BasicVSR/IconVSR_Vimeo90K_BIx4-35fec07c.pth')


### Get Models: ###
model = IconVSR(num_feat=64, num_block=30,keyframe_stride=5,
                 temporal_padding=3, spynet_path = None).cuda()
model.load_state_dict(torch.load(model_path_iconvsr)['params'])
