...
Train_dict.Network_checkpoint_prefix = 'BasicVSR (Vimeo90K BI pth) ALPR [400,256] SR'
...
model_path_basicvsr = os.path.join(base_path,'Pretrained Checkpoints/BasicVSR/BasicVSR_Vimeo90K_BIx4-2a29695a.pth')
