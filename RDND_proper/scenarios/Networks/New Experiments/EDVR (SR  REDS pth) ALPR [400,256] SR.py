...
TensorBoard_path = '/home/mafat/Desktop/Omer/tb'
vrt_path = osp.join(base_path, 'VRT')
data_path = osp.join(vrt_path, 'testsets')

reds_train_path = 'REDS4/GT/000' # 'REDS4/blur/000'
reds_test_path = 'REDS4/GT/000'
...
Train_Images_Folder  = osp.join(data_path, reds_train_path)
Test_Images_Folder = osp.join(data_path, reds_test_path)
...
Train_dict.Network_checkpoint_prefix = 'EDVR (SR REDS pth) ALPR [400,256] SR'
...
Train_dict = TrainingCore.training_utils.PreTraining_Aux(Train_dict, Network_checkpoint_folder, base_path)
##########################################################################################
...
IO_dict.blur_size = 2
IO_dict.number_of_blur_steps_per_pixel = 5
...
# train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AWGNNoise_DirectionalBlur(Train_Images_Folder, IO_dict)
# test_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AWGNNoise_DirectionalBlur(Test_Images_Folder, IO_dict_test)

train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AWGNNoise(Train_Images_Folder, IO_dict)
test_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AWGNNoise(Test_Images_Folder, IO_dict_test)
...
preprocessing_object = PreProcessing_EDVR_Gimbaless()
