...
Train_dict.Network_checkpoint_prefix = 'FastDVDNet_Deblur ALPR [400,256] SR-Deblur'
...
### Get Models: ###
model = FastDVDnet_Deblur(in_channels=3, out_channels = 3,  num_input_frames=5).cuda()


model_path = os.path.join(base_path,'Model Checkpoints/FastDVDNet_Deblur Overfit Single Image'
                                    '/FastDVDNet_Deblur Overfit Single Image_TEST1_Step60000'
                                    '.tar')
model.load_state_dict(torch.load(model_path)['model_state_dict'])
# model.load_state_dict(torch.load(model_path_edvr_deblur)['params'])
