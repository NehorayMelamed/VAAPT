...
Train_dict.Network_checkpoint_prefix = 'FastDVDNet_SuperResolution_2'
...
#####################################################################################################################################################################
### Model Itself: ###
model = FastDVDnet_SuperResolution_NoNoiseMap_NoLimitOnFrames(in_channels=1,
                                                     out_channels=1,
                                                     num_input_frames_per_block=3,
                                                     total_number_of_frames=5,
                                                     interim_number_of_channels=32,
                                                     downsample_factor=2)
