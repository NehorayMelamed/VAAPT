...
### Import Models: ###
from RDND_proper.models.ADNet.gray.models import ADNet
...
Train_dict.Network_checkpoint_prefix = 'ADNet_1'
...
### Load Network: ###
#######################
Train_dict.load_Network_filename = r'/home/mafat/PycharmProjects/IMOD/models/ADNet/gray/gblind/model_79.pth'
######################################################################################################################
...
#####################################################################################################################################################################
### Model Itself: ###
model = ADNet(channels=1, num_of_layers=15)
...
preprocessing_object = PreProcessing_ADNet()
preprocessing_object.flag_BW2RGB = True
postprocessing_object = PostProcessing_ADNet()
