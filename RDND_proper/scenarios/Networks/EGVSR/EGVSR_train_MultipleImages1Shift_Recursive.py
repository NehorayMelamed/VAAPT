...
######################################################################################################################
#TODO: have the same default training parameters object just like i have for a dataset IO_dict!!
...
Train_dict.Network_checkpoint_prefix = 'EGVSR_MultipleImages1Shift_Recursive_Denoise_1'
...
IO_dict.initial_crop_size = [128*16,128*16]
IO_dict.final_crop_size = [128*16,128*16]
