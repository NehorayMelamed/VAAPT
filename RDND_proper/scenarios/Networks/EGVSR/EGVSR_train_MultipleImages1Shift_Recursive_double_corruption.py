...
### Paths: ###
#(1). General Paths:
project_path = path_fix_path_for_linux('/home/mmm/Desktop/tashtit/PROJECTS/EGVSR')
inference_path_master = path_fix_path_for_linux("/home/mmm/Desktop/tashtit/PROJECTS/EGVSR/Pytorch_Checkpoints")
TensorBoard_path = path_fix_path_for_linux("/home/mmm/Desktop/tashtit/PROJECTS/EGVSR/Pytorch_Checkpoints\TensorBoard")
Network_checkpoint_folder = path_fix_path_for_linux("/home/mmm/Desktop/tashtit/PROJECTS/EGVSR/Pytorch_Checkpoints\Model_New_Checkpoints")
#(2). Train Images:
Train_Images_Folder = path_fix_path_for_linux('/home/mmm/Desktop/Aviram/vids/frames/9HIGHWAY480')
# Train_Images_Folder = os.path.join(datasets_main_folder, '/DIV2K/Image_SuperResolution/RealSR (Final)/Nikon/Train/2')
#(3). Test Images
Test_Images_Folder = path_fix_path_for_linux('/home/mmm/Desktop/Aviram/vids/frames/9HIGHWAY480')
...
Train_dict.Network_checkpoint_prefix = 'EGVSR_MultipleImages1Shift_Recursive_Denoise_1_double_corruption'
...
### Load Network: ###
#######################
Train_dict.load_Network_filename = r'/home/mmm/Desktop/tashtit/TNR_WHITE_NIGHT/models/EGVSR/pretrained_models/EGVSR_iter420000.pth'
#Train_dict.load_Network_filename = r'/home/mmm/Desktop/tashtit/PROJECTS/EGVSR/Pytorch_Checkpoints/Model_New_Checkpoints/EGVSR_MultipleImages1Shift_Recursive_Denoise_1_Checkpoint/EGVSR_MultipleImages1Shift_Recursive_Denoise_1_Checkpoint_TEST1_Step26200.tar'
...
IO_dict.flag_to_RAM = True
IO_dict.flag_noise_images_to_RAM = True
### Post Loading Stuff: ###
...
### Noise Parameters: ###
IO_dict.SNR = np.inf#3*255  # mean~10, std~2(readout)+sqrt(10)(shot)=5, effective_sigma~255/mean*5~127.5 -> SNR~4. this is only an approximation to better condition network
...
IO_dict_test.initial_crop_size = [1024,1024]
IO_dict_test.final_crop_size = [1024,1024]
...
### Get Debug Callback: ###
debug_callback = InferenceCallback_SuperResolution_Recursive(inference_path + '_debug', Train_dict)
