...
Train_dict.Network_checkpoint_prefix = 'RAFT_MultipleImages_Translation_1'
...
Train_dict.network_free_flow_description = 'RAFT'
######################################################################################################################
...
preprocessing_object = PreProcessing_RAFT()
preprocessing_object.flag_BW2RGB = True
postprocessing_object = PostProcessing_RAFT_OpticalFlow()
...
### Get Debug Callback: ###
debug_callback = TrainingCore.callbacks.InferenceCallback_OpticalFlow_Base(inference_path + '_debug', Train_dict)  #TODO: isn't the Train_dict.is_training useless now?!!
