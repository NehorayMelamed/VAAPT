...
### Import Models: ###
from RDND_proper.models.RIDNet.TestCode.code.model.ridnet import RIDNET
...
Train_dict.Network_checkpoint_prefix = 'RIDNet_1'
...
### Load Network: ###
#######################
Train_dict.load_Network_filename = r'/home/mafat/PycharmProjects/IMOD/models/RIDNet/TestCode/experiment/experiment/ridnet.pt'
######################################################################################################################
...
preprocessing_object = PreProcessing_RIDNet()
postprocessing_object = PostProcessing_RIDNet()
#####################################################################################################################################################################
