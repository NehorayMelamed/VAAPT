...
### Load Network: ###
#######################
Train_dict.load_Network_filename = r'/home/mafat/PycharmProjects/IMOD/models/GitHub/BasicSR/experiments/pretrained_models/EDVR/EDVR_L_deblur_REDS.tar'
######################################################################################################################
...
IO_dict.number_of_image_frames_to_generate = 25*1
...
### Noise Parameters: ###
IO_dict.SNR = 10  # mean~10, std~2(readout)+sqrt(10)(shot)=5, effective_sigma~255/mean*5~127.5 -> SNR~4. this is only an approximation to better condition network
...
IO_dict.blur_size = 0
IO_dict.number_of_blur_steps_per_pixel = 10
