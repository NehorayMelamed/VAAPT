...
model_denoise_path = '/raid/Pytorch_Checkpoints/2022-08-09/Model_New_Checkpoints/VRT_bayer_denoise_all_noises_harder.py' \
                     '/VRT_bayer_denoise_all_noises_harder.py_TEST1_Step108600.tar'
...
Train_Images_Folder = os.path.join(datasets_main_folder, 'Mitspe/fixed')
...
Test_Images_Folder = os.path.join(datasets_main_folder, 'Mitspe/fixed')
...
IO_dict.test_args = TestArgs(tile=[18,192,192], nonblind_denoising=True, scale=1)
