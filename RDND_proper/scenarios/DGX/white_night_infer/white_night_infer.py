...
model_denoise_path = '/raid/Pytorch_Checkpoints/2022-08-09/Model_New_Checkpoints/VRT_bayer_denoise_less_noises.py' \
                     '/VRT_bayer_denoise_less_noises.py_TEST1_Step8550.tar'
