...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_denoise_6_frames
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + 'quant'
...
IO_dict.noise_dict.per_pixel_readout_noise_sigma = 3
### Post Loading Stuff: ###
...
IO_dict_test.number_of_image_frames_to_generate = 6 * 5
IO_dict_test.number_of_images_per_video_to_load = 6 * 5
#######################################################################################################################################
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_6_frames(model_checkpoints[0], device=IO_dict.model_devices[0])
