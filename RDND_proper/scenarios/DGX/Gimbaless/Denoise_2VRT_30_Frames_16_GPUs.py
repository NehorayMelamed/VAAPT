...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_denoise_deblur_6_frames_16_GPUs
...
# model_denoise_path = osp.join(Network_checkpoint_folder, 'Denoise_1VRT_30_frames_8_GPUS_harder_noise.py/Denoise_1VRT_30_frames_8_GPUS_harder_noise.py_TEST1_Step75.tar')
...
Train_Images_Folder = osp.join(datasets_main_folder, 'DIV2K/DIV2K/DIV2K_valid_HR')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'DIV2K/DIV2K/DIV2K_valid_HR')
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + 'screen mode'
...
IO_dict.Corrupted_string_pattern_to_search = '*val_blur_only*'
IO_dict.GT_string_pattern_to_search = '*val_sharp*'
...
IO_dict.number_of_image_frames_to_generate = 6 * 5
IO_dict.number_of_images_per_video_to_load = 6 * 5
### Miscellenous: ###
...
IO_dict.transforms_dict.shift_size = 5
...
IO_dict_test.number_of_image_frames_to_generate = 12 * 5
IO_dict_test.number_of_images_per_video_to_load = 12 * 5
#######################################################################################################################################
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_deblur_6_frames_16_GPUs(model_checkpoints)
