...
Train_Images_Folder = osp.join(base_path, 'save_folder_RGB')
...
Train_Images_Folder = os.path.join(datasets_main_folder, 'Example_videos/Beirut_BW_Original')
...
Test_Images_Folder = osp.join(base_path, 'save_folder_RGB')
# Test_Images_Folder = os.path.join(datasets_main_folder, 'DIV2K/DIV2K/DIV2K_train_HR_BW')
Test_Images_Folder = os.path.join(datasets_main_folder, 'Example_videos/Beirut_BW_Original')
...
Train_dict.flag_movie_inference = True
...
####################################
### DataSets: ###
train_dataset = TrainingCore.datasets.DataSet_SingleVideo_RollingIndex_AGN(Train_Images_Folder, IO_dict)
test_dataset = TrainingCore.datasets.DataSet_SingleVideo_RollingIndex_AGN(Test_Images_Folder, IO_dict_test)
...
validation_callback = InferenceCallback_Movie(inference_path + '_validation', Train_dict)
