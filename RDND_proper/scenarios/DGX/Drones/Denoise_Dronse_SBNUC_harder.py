...
model_denoise_path = osp.join(Network_checkpoint_folder, 'Denoise_Dronse_SBNUC_harder.py/Denoise_Dronse_SBNUC_harder.py_TEST1_Step5325.tar')
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_infer'
