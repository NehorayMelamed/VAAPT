...
# model_denoise_path = osp.join(Network_checkpoint_folder, 'Denoise_drones_1VRT_6_Frames_8_GPUs_RGB.py/Denoise_drones_1VRT_6_Frames_8_GPUs_RGB.py_TEST1_Step12300.tar')
model_denoise_path = osp.join(Network_checkpoint_folder, 'Denoise_drones_SBNUC_harder_blob.py_second_attempt/Denoise_drones_SBNUC_harder_blob.py_second_attempt_TEST1_Step9075.tar')
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_second_attempt_inference'
...
IO_dict_test.number_of_image_frames_to_generate = 400
IO_dict_test.number_of_images_per_video_to_load = 400
#######################################################################################################################################
