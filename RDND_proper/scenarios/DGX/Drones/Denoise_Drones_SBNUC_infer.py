...
# model_denoise_path = osp.join(Network_checkpoint_folder, 'Denoise_drones_1VRT_6_Frames_8_GPUs_RGB.py/Denoise_drones_1VRT_6_Frames_8_GPUs_RGB.py_TEST1_Step12300.tar')
model_denoise_path = osp.join(Network_checkpoint_folder, 'Denoise_drones_SBNUC.py_row+col_fixed_dataset_new/Denoise_drones_SBNUC.py_row+col_fixed_dataset_new_TEST1_Step1425.tar')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'drones/T/train')
...
Train_dict.number_of_validation_samples = 9
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) +'train_inference'
...
IO_dict.noise_dict.RRNU_sigmas_polynomial_params = [0.1,0.1]
IO_dict.noise_dict.CRNU_sigmas_polynomial_params = [0.1,0.1]
