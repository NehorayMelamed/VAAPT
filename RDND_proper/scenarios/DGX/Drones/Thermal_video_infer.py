...
model_denoise_path = osp.join(Network_checkpoint_folder, 'Thermal_video_train.py/Thermal_video_train.py_TEST1_Step8700.tar')
...
Train_Images_Folder = osp.join(datasets_main_folder, 'Thermal_test_video')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'Thermal_test_video')
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + 'try'
...
IO_dict.test_args = TestArgs(tile=[20,192,192])
### Loading Images: ###
#(1). Folder names:
#(1.1). Root Folder:
