...
model_denoise_path = osp.join(Network_checkpoint_folder, 'Denoise_drones_1VRT_6_Frames_8_GPUs_BW.py/Denoise_drones_1VRT_6_Frames_8_GPUs_BW.py_TEST1_Step3300.tar')
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_3300 pretrained'
