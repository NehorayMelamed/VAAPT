...
model_denoise_path = osp.join(Network_checkpoint_folder, 'Thermal_video_train.py/Thermal_video_train.py_TEST1_Step900.tar')
...
IO_dict_test.mean_gray_level_per_pixel = [11,11]
