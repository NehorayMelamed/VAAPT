...
IO_dict.Corrupted_string_pattern_to_search = '*val_blur*'
...
IO_dict.noise_dict.flag_add_per_pixel_readout_noise = False # True
IO_dict.noise_dict.flag_add_external_readout_noise = False
IO_dict.noise_dict.flag_add_shot_noise = False #True
IO_dict.noise_dict.flag_quantize_images = False #True
...
IO_dict_test.number_of_image_frames_to_generate = 20
IO_dict_test.number_of_images_per_video_to_load = 20
#######################################################################################################################################
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_deblur_6_frames_checkpoint(pretrained=True, checkpoint_path=model_deblur_path,
