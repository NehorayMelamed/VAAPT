...
IO_dict.PPP = [2] #[2, 10]  # Photons per Pixel.
### Noise Addition: ###
temp_factor = 12/255
...
######################################################################################################################################
### Show images: ###
# a = test_dataset[7].output_frames_noisy
# imshow_torch(a[0]/a.max())
# plt.show(block=True)


#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_6_frames_checkpoint(pretrained=False, checkpoint_path=model_denoise_path,
