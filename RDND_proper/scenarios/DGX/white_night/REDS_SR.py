...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_SR_6_frames_checkpoint
...
IO_dict.test_args = TestArgs(tile=[20,192,192], nonblind_denoising=False, window_size=[6,8,8])
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_SR_6_frames_checkpoint(pretrained=True, checkpoint_path=model_SR_path,
