...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_v2'
...
IO_dict_test.number_of_image_frames_to_generate = 40
IO_dict_test.number_of_images_per_video_to_load = 40
#######################################################################################################################################
