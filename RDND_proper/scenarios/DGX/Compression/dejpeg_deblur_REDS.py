...
model_deblur_path = '/raid/Pytorch_Checkpoints/2022-05-31/Model_New_Checkpoints/dejpeg_deblur_REDS.py/dejpeg_deblur_REDS.py_TEST1_Step11400.tar'
...
Train_dict.number_of_validation_samples = 30
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_inference2'
...
IO_dict.test_args = TestArgs(tile=[12,192,192], nonblind_denoising=False)
...
IO_dict.Corrupted_string_pattern_to_search = '*val_blur_jpeg*'
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_deblur_6_frames_checkpoint(False, model_deblur_path, IO_dict.device, IO_dict.test_device)
