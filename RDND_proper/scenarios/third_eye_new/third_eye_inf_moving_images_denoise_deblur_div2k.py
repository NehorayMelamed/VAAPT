...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_deblur_6_frames_checkpoint, VRT_denoise_6_frames_checkpoint
...
model_denoise_path = '/raid/Pytorch_Checkpoints/2022-07-20/Model_New_Checkpoints/moving_images_denoise_deblur_div2k.pydeblur_pretrained.py' \
                     '/moving_images_denoise_deblur_div2k.pydeblur_pretrained.py_TEST1_Step2925.tar'
...
model_deblur_path = '/raid/Pytorch_Checkpoints/2022-07-20/Model_New_Checkpoints/moving_images_denoise_deblur_drones.pydeblur_pretrained' \
                    '/moving_images_denoise_deblur_drones.pydeblur_pretrained_TEST1_Step3000.tar'
...
IO_dict.test_args = TestArgs(tile=[18,192,192], nonblind_denoising=False)
IO_dict.no_GT = False
### Loading Images: ###
#(1). Folder names:
#(1.1). Root Folder:
...
### Miscellenous: ###
IO_dict.flag_normalize_images_to_PPP = False #True
IO_dict.PPP = [50, 50] #[2, 10]  # Photons per Pixel.
### Noise Addition: ###
temp_factor = 70/255
...
sigma = 20
eps = sigma/10
IO_dict.noise_dict.per_pixel_readout_noise_sigma = (sigma-eps, sigma+eps)
...
# Model Noises
IO_dict.noise_dict.flag_add_per_pixel_readout_noise = False # 1)
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_deblur_6_frames_checkpoint(False, checkpoint_path=model_deblur_path, train_device=train_devices[0],
