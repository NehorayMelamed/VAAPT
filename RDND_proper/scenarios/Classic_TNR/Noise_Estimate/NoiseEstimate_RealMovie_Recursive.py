...
original_frames_folder = os.path.join(datasets_main_folder, '/KAYA_EXPERIMENT/4')
...
### Results Paths: ###
results_path = '/home/mafat/PycharmProjects/IMOD/scenarios/Noise_Estimation_Results/Recursive/RealMovies'
...
### Choose Methos: ###
number_of_images = min(100,len(original_frames_dataset.image_filenames_list_of_lists[0]))
