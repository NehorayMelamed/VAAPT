...
dist = False
json_path = 'options/vrt/007_train_vrt_videodeblurring_reds_omer.json'
json_path = 'options/vrt_omer/008_train_vrt_videodenoising_davis_omer.json'
...
from RDND_proper.models.vrt_models import VRT_denoise

net_G = VRT_denoise(pretrained=True).cuda()
model.netG = net_G
