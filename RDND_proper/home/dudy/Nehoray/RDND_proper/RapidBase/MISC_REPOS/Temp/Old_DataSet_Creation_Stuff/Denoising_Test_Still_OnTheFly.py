...
models_folder = 'G:\CHECKPOINTSConvLSTM_1_0_2_1_2_0'
load_Generator_filename = 'ConvLSTM_1_0_2_1_2_0_TEST1_Step5000_GenLR_2d00em03_Loss_0D03414583206176758.pt';

### Save filenames and folders: ###
save_figures_super_folder = 'C:/Users\dkarl\PycharmProjects\dudykarl\TNR\Official Testing/Still Images On The Fly'
save_Generator_filename = load_Generator_filename.split('_TEST1')[0]
save_figures_folder = os.path.join(save_figures_super_folder, save_Generator_filename)
...
Generator_Network = torch.load(os.path.join(models_folder,load_Generator_filename))
...
#(*). Still Images
batch_size = 100; #Number of images in the multiple_Test_Images_To_Change_On_The_Fly folder
crop_size = 100
