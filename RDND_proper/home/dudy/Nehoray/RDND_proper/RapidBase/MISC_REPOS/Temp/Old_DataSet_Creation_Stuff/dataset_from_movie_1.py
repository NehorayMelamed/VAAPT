...
def split_video_into_constant_time_chunks(movie_full_filenames):
    ...
    number_of_frames_per_sequence = int(25*1);  # 30[fps] * #[number of seconds]
                        ...
                        for width_crop_index in arange(number_of_width_crops):
                            for height_crop_index in arange(number_of_height_crops):
                                if current_crop_counter in random_crop_indices_per_crop_size[crop_size_counter]:
                                    ...
                                    ### Save Image: ####
                                    if flag_binary_or_images == 'images' or flag_binary_or_images == 'both':
                                        #(1). Image In Folders:
                                    ...
                                    if flag_binary_or_images == 'binary' or flag_binary_or_images == 'both':
                                        #(2). Binary File:
...
def display_images_in_image_folder_in_matplotlib(images_folder_name):
    images_folder_name = 'F:\TNR - OFFICIAL TEST IMAGES\Long_Video/NoiseGain_100\LONG_VIDEO/UNET_V26_V1__IntegerShifts1_LSTM_flags_Noise30_TWICE\ALL_DETAILS\Concat'

    images_list = read_images_from_folder_to_list(images_folder_name, IMG_EXTENSIONS_PNG, flag_recursive=False, flag_convert_to_rgb=False)
