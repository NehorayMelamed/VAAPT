...
if __name__ == '__main__':
    ...
    for batch_index in range(num_batches):
        ...
        flag_estimate_new_bg = (start_video % experiment_dict.number_of_frames_per_bg) < batch_size
        stabilize_batch(video_tensor, flag_estimate_new_bg=flag_estimate_new_bg, input_range=input_range,
                        bg_range=bg_range, experiment_dict=experiment_dict)
        if flag_estimate_new_bg:
            bg_range = input_range
        torch.cuda.empty_cache()
