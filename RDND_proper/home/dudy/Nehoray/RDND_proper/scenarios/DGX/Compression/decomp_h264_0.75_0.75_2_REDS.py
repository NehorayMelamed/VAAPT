...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_inference'
...
IO_dict.flag_use_train_dataset_split = True ### Use Train/Test Split Instead Of Distinct Test Set: ###
...
IO_dict.Corrupted_string_pattern_to_search = '*val_h264_0.75M_0.75M_2M_images*'
