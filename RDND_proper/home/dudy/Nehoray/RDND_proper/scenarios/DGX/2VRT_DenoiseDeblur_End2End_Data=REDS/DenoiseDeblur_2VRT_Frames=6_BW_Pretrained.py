...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_denoise_deblur_6_frames_2_GPUs
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_REDS'
...
IO_dict.flag_to_RGB_after_noise = True
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_deblur_6_frames_2_GPUs(model_checkpoints, devices=IO_dict.model_devices)
