...
#(2). Train Images:
Train_Images_Folder = osp.join(home_path, 'REDS_noised/PP1.5/')
...
Test_Images_Folder = osp.join(home_path, 'REDS_noised/PP1.5/')
...
IO_dict.Corrupted_string_pattern_to_search = '*Noisy_vid_images*'
IO_dict.GT_string_pattern_to_search = '*Clean*'
...
#####################################################################################################################################################################
### Get Loss Object: ###
Loss_object = RapidBase.TrainingCore.losses.Loss_grad_VRT(inputs_dict=None) #L1 only
