...
IO_dict.test_args = TestArgs(tile=[12,128,128], nonblind_denoising=True)
...
IO_dict_test.number_of_image_frames_to_generate = 3000
IO_dict_test.number_of_images_per_video_to_load = 3000
#######################################################################################################################################
