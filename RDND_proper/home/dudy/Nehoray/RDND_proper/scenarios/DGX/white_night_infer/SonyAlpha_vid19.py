...
Train_Images_Folder = os.path.join(datasets_main_folder, 'SonyAlpha/small_images/19')
...
Test_Images_Folder = os.path.join(datasets_main_folder, 'SonyAlpha/small_images/19')
