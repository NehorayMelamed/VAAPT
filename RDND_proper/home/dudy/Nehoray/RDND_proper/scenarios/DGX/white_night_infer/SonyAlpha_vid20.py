...
Train_Images_Folder = os.path.join(datasets_main_folder, 'SonyAlpha/small_images20/20')
...
Test_Images_Folder = os.path.join(datasets_main_folder, 'SonyAlpha/small_images20/20')
...
IO_dict.test_args = TestArgs(tile=[12,192,192], nonblind_denoising=True)
### Loading Images: ###
#(1). Folder names:
#(1.1). Root Folder:
