...
# model_denoise_path = '/raid/Pytorch_Checkpoints/2022-05-31/Model_New_Checkpoints/drones_RGB_WN.py_2/drones_RGB_WN.py_2_TEST1_Step7575.tar'
# model_denoise_path = osp.join('/raid/Model_New_Checkpoints', 'Denoise_drones_SBNUC.py_row+col/Denoise_drones_SBNUC.py_row+col_TEST1_Step9300.tar')
model_deblur_path = osp.join(base_path, 'Checkpoints/VRT/007_VRT_videodeblurring_REDS.pth')
model_denoise_path = '/raid/Pytorch_Checkpoints/2022-08-09/Model_New_Checkpoints/VRT_bayer_denoise_less_noises_harder.py' \
                     '/VRT_bayer_denoise_less_noises_harder.py_TEST1_Step8550.tar'
...
Train_Images_Folder = os.path.join(datasets_main_folder, 'Mitspe/new_images')
...
Test_Images_Folder = os.path.join(datasets_main_folder, 'Mitspe/new_images')
...
Train_dict.number_of_validation_samples = 2
