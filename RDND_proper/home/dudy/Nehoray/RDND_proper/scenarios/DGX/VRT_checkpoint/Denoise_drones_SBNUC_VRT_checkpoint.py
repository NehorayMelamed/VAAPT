...
inference_path_master = osp.join(base_path, 'Pytorch_Checkpoints', today_date)
...
model_denoise_path = osp.join('/raid/Model_New_Checkpoints', 'Denoise_Dronse_SBNUC_harder.py/Denoise_Dronse_SBNUC_harder.py_TEST1_Step5325.tar')
