...
# model_denoise_path = osp.join(Network_checkpoint_folder, 'Denoise_drones_1VRT_6_Frames_8_GPUs_RGB.py/Denoise_drones_1VRT_6_Frames_8_GPUs_RGB.py_TEST1_Step12300.tar')
model_denoise_path = osp.join(Network_checkpoint_folder, 'Denoise_drones_SBNUC.py_row+col/Denoise_drones_SBNUC.py_row+col_TEST1_Step9300.tar')
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_row+col_fixed_dataset_new'
