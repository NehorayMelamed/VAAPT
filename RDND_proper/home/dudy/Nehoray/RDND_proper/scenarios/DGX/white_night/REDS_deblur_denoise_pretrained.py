...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_denoise_deblur
...
model_denoise_path = '/raid/Pytorch_Checkpoints/2022-06-06/Model_New_Checkpoints/REDS_denoise.py/REDS_denoise.py_TEST1_Step675.tar'
model_deblur_path = '/raid/Pytorch_Checkpoints/2022-06-06/Model_New_Checkpoints/REDS_deblur.py/REDS_deblur.py_TEST1_Step675.tar'
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_deblur(model_checkpoints,[torch.device(i) for i in train_devices]
                           , [torch.device(i) for i in test_devices], pretrained)
