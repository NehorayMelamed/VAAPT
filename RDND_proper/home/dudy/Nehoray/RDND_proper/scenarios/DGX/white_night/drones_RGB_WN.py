...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_[1,5]'
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_6_frames_checkpoint(True, model_denoise_path, IO_dict.device, IO_dict.test_device)
