...
model_denoise_path = osp.join(Network_checkpoint_folder, 'Denoise_1VRT_30_Frames_8_GPUs.pyhard_noises + no_overfit/Denoise_1VRT_30_Frames_8_GPUs.pyhard_noises + no_overfit_TEST1_Step75.tar')
...
Train_Images_Folder = osp.join(datasets_main_folder, 'DIV2K/DIV2K/DIV2K_train_HR')
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + 'hard_noises + no_overfit(2)'
...
IO_dict.noise_dict.per_pixel_readout_noise_sigma = 4
### Post Loading Stuff: ###
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_6_frames_8_GPUs(pretrained=False, checkpoint_path=model_checkpoints[0], devices=IO_dict.model_devices)
