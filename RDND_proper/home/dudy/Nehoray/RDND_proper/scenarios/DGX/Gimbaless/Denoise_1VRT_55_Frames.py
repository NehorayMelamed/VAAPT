...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_denoise_11_frames
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_all_noises'
...
IO_dict.number_of_image_frames_to_generate = 11 * 5
IO_dict.number_of_images_per_video_to_load = 11 * 5
### Miscellenous: ###
...
IO_dict_test.number_of_image_frames_to_generate = 11 * 5
IO_dict_test.number_of_images_per_video_to_load = 11 * 5
#######################################################################################################################################
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_11_frames(model_checkpoints[0], device=IO_dict.model_devices[0])
