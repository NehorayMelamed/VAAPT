...
# Train_Images_Folder = path_fix_path_for_linux(os.path.join(base_path, 'Data', 'testRGB'))
#(3). Test Images
...
# Train_Images_Folder = path_fix_path_for_linux('C:/Users/Omer Leibovitch/Desktop/Work/Data/words/a01/a01-000u/')
# Test_Images_Folder = path_fix_path_for_linux(os.path.join(base_path, 'Data', 'testRGB'))
#RGB images
...
Train_dict.Network_checkpoint_prefix = 'BasicVSR_finetune_L1_1e-4_yes-gradclip_overfit_DIV2K-BW_scale=2'
...
optimization_dict.learning_rate_lowering_patience_before_lowering = 20000
