...
Train_dict.Network_checkpoint_prefix = 'RLSP_MultipleImages1Shift_1_NonRecursive'
...
### Get Debug Callback: ###
debug_callback = TrainingCore.callbacks.InferenceCallback_DenoisingSuperResolution_Base(inference_path + '_debug', Train_dict.is_training, Train_dict)  #TODO: isn't the Train_dict.is_training useless now?!!
### Get Validation Callback: ###
validation_callback = TrainingCore.callbacks.InferenceCallback_DenoisingSuperResolution_Base(inference_path + '_validation', Train_dict.is_training, Train_dict)
