...
from RapidBase.TrainingCore.pre_post_callbacks import PostProcessing_Denoise_Recursive_Base
...
Train_dict.Network_checkpoint_prefix = 'FastDVDNet2_PreLU_Kaya_Image0Shift_Recursive_RunAvgMean_FineTune'
# Train_dict.Network_checkpoint_prefix = 'FastDVDNet2_PreLU_Kaya_Video_Recursive_1_FineTune'
...
### Load Network: ###
#######################
Train_dict.load_Network_filename = path_fix_path_for_linux(r'/home/mafat\PycharmProjects\IMOD\models\DVDNet\dvdnet/model_combined.pth')
# Train_dict.load_Network_filename = path_fix_path_for_linux(r'FastDVDNet2_PreLU_Kaya_Image0Shift_Recursive_1_TEST1_Step81000.tar')
# Train_dict.load_Network_filename = path_fix_path_for_linux(r'FastDVDNet2_PreLU_Kaya_Image0Shift_Recursive_1_FineTune_Checkpoint_TEST1_Step97000.tar')
Train_dict.load_Network_filename = path_fix_path_for_linux(r'FastDVDNet2_PreLU_Kaya_Image0Shift_Recursive_RunAvgValue_FineTune_Checkpoint_TEST1_Step110600.tar')
...
#####################################################################################################################################################################
### Model Itself: ###
model = FastDVDnet_dudy_2_Recursive(in_channels=3, num_input_frames=5)
...
preprocessing_object = PreProcessing_FastDVDNet_Recursive()
preprocessing_object.flag_BW2RGB = True
postprocessing_object = PostProcessing_Denoise_Recursive_Base()
#####################################################################################################################################################################
