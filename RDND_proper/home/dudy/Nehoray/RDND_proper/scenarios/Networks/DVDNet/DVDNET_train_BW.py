...
from RapidBase.TrainingCore.pre_post_callbacks import PreProcessing_Base, PreProcessing_DVDNet_BW
...
Train_dict.save_models_frequency = 100
...
Network_save_load_dict.Network_checkpoint_prefix = 'DVDNet_BW_2'
...
### Noise Parameters: ###
IO_dict.sigma_to_dataset = 1/sqrt(5)*255
IO_dict.SNR_to_model = 5
IO_dict.sigma_to_model = 1/sqrt(IO_dict.SNR_to_model)*255
# IO_dict.sigma_to_model = 80
### Blur Parameters: ###
#(*). Directional Blur:
IO_dict.blur_size = 4
IO_dict.number_of_blur_steps_per_pixel = 4
#(*). Gaussian Blur:
Train_dict.blur_number_of_channels = 3
Train_dict.blur_kernel_size = 9
Train_dict.blur_sigma = 3
...
####################################
### DataSets: ###
train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AddNoise_Blur(Train_Images_Folder,
...
model = DVDNet_dudy_BW(temp_psz=IO_dict.NUM_IN_FRAMES, mc_algo=MC_ALGO)
...
preprocessing_object = PreProcessing_DVDNet_BW()
