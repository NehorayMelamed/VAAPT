...
# Test_Images_Folder = os.path.join(datasets_main_folder, '/Example Videos/LWIR_video_original')
# Test_Images_Folder = os.path.join(datasets_main_folder, '/Example Videos/SWIR_video_original')
# Test_Images_Folder = path_fix_path_for_linux(r'/home/mafat/DataSets/DataSets/Div2K/DIV2K_train_HR_BW_Crops_Videos')
Inference_folder_name_addon = 'SNR5_New_WithMean'
###
...
debug_callback = TrainingCore.callbacks.InferenceCallback_ExampleFolder_WithActualMean(inference_path, Train_dict.is_training)
