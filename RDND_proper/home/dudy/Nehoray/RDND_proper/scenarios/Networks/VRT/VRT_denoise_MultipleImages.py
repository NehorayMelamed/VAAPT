...
Train_Images_Folder = osp.join(base_path ,'DIV2K_valid_HR')
#Images
Test_Images_Folder = osp.join(base_path ,'DIV2K_valid_HR')
...
Train_dict.Network_checkpoint_prefix = 'VRT_denoise_shot_noise_quant_no_blur'
...
IO_dict.PPP = 3  # Photons per Pixel.
### Noise Addition: ###
...
IO_dict.final_crop_size = [192, 192]
...
IO_dict_test.initial_crop_size = [272,272] #np.inf
