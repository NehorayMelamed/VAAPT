...
Train_dict.Network_checkpoint_prefix = 'EDVR (no pcd, SR + Blur REDS pth) ALPR [400,256] SR'
...
model_path_edvr_sr = os.path.join(base_path,'Pretrained Checkpoints/EDVR/EDVR_L_x4_SRblur_REDS_official-983d7b8e.pth')
