...
Train_dict.Network_checkpoint_prefix = 'SwinIR (Divk2K Medium pth) ALPR [400,256] SR'
...
model_path = os.path.join(base_path,'Pretrained Checkpoints/SwinIR/001_classicalSR_DIV2K_s48w8_SwinIR-M_x4.pth')
