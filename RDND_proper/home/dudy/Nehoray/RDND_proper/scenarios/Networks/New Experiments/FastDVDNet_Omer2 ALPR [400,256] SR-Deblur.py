...
Train_dict.Network_checkpoint_prefix = 'FastDVDNet_Omer2 ALPR [400,256] SR-Deblur'
...
IO_dict.number_of_image_frames_to_generate = 9 #5
...
### Get Models: ###
model = FastDVDnet_Omer2(in_channels=3, out_channels = 3,  num_input_frames=9).cuda()
