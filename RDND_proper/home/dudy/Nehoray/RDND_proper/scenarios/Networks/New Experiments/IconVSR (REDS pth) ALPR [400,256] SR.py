...
Train_dict.Network_checkpoint_prefix = 'IconVSR (REDS pth) ALPR [400,256] SR'
...
model_path_iconvsr = os.path.join(base_path,'Pretrained Checkpoints/BasicVSR/IconVSR_REDS-aaa5367f.pth')


### Get Models: ###
model = IconVSR(num_feat=64, num_block=30,keyframe_stride=5,
                 temporal_padding=2, spynet_path = None).cuda()
