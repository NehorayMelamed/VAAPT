...
Train_dict.Network_checkpoint_prefix = 'BasicVSR (Vimeo90K BD pth) ALPR [400,256] SR'
...
model_path_basicvsr = os.path.join(base_path,'Pretrained Checkpoints/BasicVSR/BasicVSR_Vimeo90K_BDx4-e9bf46eb.pth')


### Get Models: ###
model= BasicVSR(num_feat=64, num_block=30, spynet_path = None).cuda()
model.load_state_dict(torch.load(model_path_basicvsr)['params'])
