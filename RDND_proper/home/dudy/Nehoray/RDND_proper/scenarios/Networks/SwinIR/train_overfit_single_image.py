...
Train_dict.Network_checkpoint_prefix = 'SwinIR-LW_finetune_L1_3e-4_yes-gradclip_overfit-DIV2-BW_image-scale=2_from_scratch_C=19'
...
IO_dict.number_of_image_frames_to_generate = 19 #5
...
model = SwinIR(upscale=4, in_chans=19, img_size=64, window_size=8,
...
#
# model.load_state_dict(torch.load(model_path_div2k)['params'])
