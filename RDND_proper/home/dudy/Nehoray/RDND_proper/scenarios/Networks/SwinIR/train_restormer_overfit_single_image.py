...
from RapidBase.TrainingCore.pre_post_callbacks import PreProcessing_RLSP_Recursive, PreProcessing_Restformer, PostProcessing_Restformer
...
Train_dict.Network_checkpoint_prefix = 'Restormer overfit 3 no clipping'
...
scale = 1.25 # To make crop_size changes easier
offset = 5
...
IO_dict_test.initial_crop_size = [256+offset, 256+offset] #np.inf
IO_dict_test.final_crop_size = [256, 256] #np.inf
...
preprocessing_object = PreProcessing_Restformer()
preprocessing_object.flag_BW2RGB = False
postprocessing_object = PostProcessing_Restformer()
