...
experiment_name = 'SwinIR Large'
project_path = path_fix_path_for_linux(os.path.join(base_path, 'IMOD'))
inference_path_master = path_fix_path_for_linux(os.path.join(base_path, 'Results', experiment_name, 'Inference'))
TensorBoard_path = path_fix_path_for_linux(os.path.join(base_path, 'Results', experiment_name, 'TensorBoard'))
Network_checkpoint_folder = path_fix_path_for_linux(os.path.join(base_path, 'Results', experiment_name, 'Model Checkpoints'))
#(2). Train Images:
