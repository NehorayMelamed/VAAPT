...
### Import Models: ###
from RDND_proper.models.SADNet.model.sadnet import SADNET
...
Train_dict.Network_checkpoint_prefix = 'SADNet_1'
...
### Load Network: ###
#######################
Train_dict.load_Network_filename = r'/home/mafat/PycharmProjects/IMOD/models/SADNet/ckpt/ckpt/SADNET_color_sig70/model_0200_dict.pth'
Train_dict.load_Network_filename = r'/home/mafat/PycharmProjects/IMOD/models/SADNet/ckpt/ckpt/SADNET_gray_sig70/model_0200_dict.pth'
######################################################################################################################
...
model = SADNET(input_channel=1, output_channel=1, n_channel=32, offset_channel=32)
...
preprocessing_object = PreProcessing_SADNet()
postprocessing_object = PostProcessing_SADNet()
#####################################################################################################################################################################
...
### Get Debug Callback: ###
debug_callback = InferenceCallback_Denoise(inference_path + '_debug', Train_dict.is_training, Train_dict)  #TODO: isn't the Train_dict.is_training useless now?!!
debug_callback.frame_index_to_predict = 0
### Get Validation Callback: ###
validation_callback = InferenceCallback_Denoise(inference_path + '_validation', Train_dict.is_training, Train_dict)
