...
# Train_Images_Folder = path_fix_path_for_linux('C:/Users/Omer Leibovitch/Desktop/Work/Data/REDS/val_blur/val/val_blur/004')
...
# Test_Images_Folder = path_fix_path_for_linux('C:/Users/Omer Leibovitch/Desktop/Work/Data/REDS/val_blur/val/val_blur/004')
...
Train_dict.Network_checkpoint_prefix = 'FastDVDNet_Denoise_1'
...
IO_dict.noise_dict.per_pixel_readout_noise_sigma = 20
### Transforms / Warping: ###
...
#####################################################################################################################################################################
### Model Itself: ###
model = FastDVDnet_Deblur_NoNoiseMap_NoLimitOnFrames(in_channels=1,
                                                     out_channels=1,
                                                     num_input_frames_per_block=3,
                                                     total_number_of_frames=5,
                                                     interim_number_of_channels=15)
