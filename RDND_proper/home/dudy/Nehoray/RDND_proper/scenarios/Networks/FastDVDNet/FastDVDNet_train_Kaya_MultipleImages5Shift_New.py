...
### Import Models: ###
from RDND_proper.models.FastDVDNet.models import FastDVDnet, FastDVDnet_dudy
...
Train_dict.Network_checkpoint_prefix = 'FastDVDNet_KayaCamera_MultipleImagesNoShift_NewEnv_1'
# Train_dict.Network_checkpoint_prefix = 'FastDVDNet_KayaCamera_MultipleImagesNoShift_OriginalCheckpoint_1'
...
Train_dict.network_free_flow_description = 'multiple images from single image with added camera noise. finetune checkpoint'
######################################################################################################################
...
### Load Network: ###
#######################
Train_dict.load_Network_filename = r'/home/mafat/PycharmProjects/IMOD/models/FastDVDNet/model.pth'
# Train_dict.load_Network_filename = r'/home/mafat/PycharmProjects/IMOD/models/FastDVDNet/model_clipped_noise.pth'
######################################################################################################################
...
####################################
### DataSets: ###
train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AddExternalNoiseImage(Train_Images_Folder, Camera_Noise_Folder, IO_dict)
test_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AddExternalNoiseImage(Test_Images_Folder, Camera_Noise_Folder, IO_dict_test)
...
#####################################################################################################################################################################
### Model Itself: ###
model = FastDVDnet_dudy(in_channels=3, num_input_frames=5)
...
preprocessing_object = PreProcessing_FastDVDNet_KayaCamera()
preprocessing_object.flag_BW2RGB = True
postprocessing_object = PostProcessing_FastDVDNet()
...
### Get Debug Callback: ###
debug_callback = InferenceCallback_Denoise(inference_path + '_debug', Train_dict)
