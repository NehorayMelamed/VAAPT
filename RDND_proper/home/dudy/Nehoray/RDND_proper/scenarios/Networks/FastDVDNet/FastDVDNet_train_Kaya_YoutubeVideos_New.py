...
######################################################################################################################
### Train/Inference/Debug Parameters: ###Network_save_load_dict
...
Train_dict.Network_checkpoint_prefix = 'FastDVDNet_KayaCamera_YouTube_FinetunningHigherNoise_1'
...
Train_dict.load_Network_filename = r'FastDVDNet_KayaCamera_YouTube_FinetunningHigherNoise_1_Checkpoint_TEST1_Step219000.tar'
######################################################################################################################
...
####################################
### DataSets: ###
train_dataset = TrainingCore.datasets.DataSet_Videos_In_Folders_AddExernalNoise(Train_Images_Folder, Camera_Noise_Folder, IO_dict)
test_dataset = TrainingCore.datasets.DataSet_Videos_In_Folders_AddExernalNoise(Test_Images_Folder, Camera_Noise_Folder, IO_dict_test)
