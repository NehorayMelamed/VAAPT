...
Train_dict.Network_checkpoint_prefix = 'FFDNet_MultipleImages_Shift2_Recursive_ConstantSigma_SingleNoiseLevel'
...
#####################################################################################################################################################################
### Model Itself: ###
model = FFDNet_dudy_Recursive(in_nc=5, out_nc=1, nc=64, nb=15, act_mode='BL')
...
preprocessing_object = PreProcessing_FFDNet_Recursive()
preprocessing_object.flag_BW2RGB = False
postprocessing_object = PostProcessing_FFDNet_Recursive()
postprocessing_object.number_of_model_input_frames = 3
...
### Get Debug Callback: ###
debug_callback = InferenceCallback_Denoise_Recursive(inference_path + '_debug', Train_dict)
### Get Validation Callback: ###
validation_callback = InferenceCallback_Denoise_Recursive(inference_path + '_validation', Train_dict)
