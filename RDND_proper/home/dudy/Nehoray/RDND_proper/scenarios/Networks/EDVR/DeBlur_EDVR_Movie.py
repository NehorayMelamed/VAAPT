...
#(3). Test Images:
Test_Images_Folder = os.path.join(datasets_main_folder, '/Example Videos/Beirut_RGB_inf')
Original_Images_Folder = os.path.join(datasets_main_folder, '/Example Videos/Beirut_RGB_inf')
...
Train_dict.Network_checkpoint_prefix = 'EDVR_1'
...
### Load Network: ###
#######################
Network_save_load_dict.load_Network_filename = r'/home/mafat/PycharmProjects/IMOD/models/GitHub/BasicSR/experiments/pretrained_models/EDVR/EDVR_L_deblur_REDS.tar'
######################################################################################################################
...
####################################
### DataSets: ###
train_dataset = TrainingCore.datasets.Dataset_MultipleImagesFromSingleImage_AWGNNoise_Shifts(root_folder=Train_Images_Folder, Train_dict=IO_dict)
