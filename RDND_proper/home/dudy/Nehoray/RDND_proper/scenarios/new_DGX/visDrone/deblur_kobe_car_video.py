...
#(2). Train Images:
Train_Images_Folder = osp.join(datasets_main_folder, 'kobe_images/crop')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'kobe_images/crop')
...
w,h,offset = 720,1080, 0# 176,320,0# 12,512,0 128, 240
...
IO_dict_test.number_of_image_frames_to_generate = 24
IO_dict_test.number_of_images_per_video_to_load = 24
#######################################################################################################################################
