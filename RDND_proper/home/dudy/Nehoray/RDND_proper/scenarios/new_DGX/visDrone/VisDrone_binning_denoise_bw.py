...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + 'X8_harder_little_more'
...
IO_dict.PPP = [5]  # Photons per Pixel.
### Noise Addition: ###
temp_factor = 20/255
...
w,h,offset = 128,128,0#  176,176,0# 12,512,0 128,128
...
w,h,offset =  128, 240,0#176,320,0# 12,512,0 128, 240
