...
#(2). Train Images:
Train_Images_Folder = osp.join(datasets_main_folder, 'drones/S/all')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'drones/S/all')
...
IO_dict.test_args = TestArgs(tile=[12,160,160], nonblind_denoising=False, scale=4)
...
IO_dict.number_of_images_per_video_to_load = 200
### Miscellenous: ###
...
####################################
### DataSets: ###
test_dataset = TrainingCore.datasets.DataSet_SingleVideo_RollingIndex_AGN(Test_Images_Folder, IO_dict)
