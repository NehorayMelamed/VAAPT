...
model_denoise_path = '/raid/old_checkpoints/Denoise_Dronse_SBNUC_harder.py/Denoise_Dronse_SBNUC_harder.py_TEST1_Step5325.tar'
...
IO_dict.test_args = TestArgs(tile=[6,192,192], nonblind_denoising=True)
IO_dict.no_GT = True

### Loading Images: ###
#(1). Folder names:
#(1.1). Root Folder:
IO_dict.root_folder = Test_Images_Folder
IO_dict.corrupted_folder = Test_Images_Folder
#(2). how to search:
