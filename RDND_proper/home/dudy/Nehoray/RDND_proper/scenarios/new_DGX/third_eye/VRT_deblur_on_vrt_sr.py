...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_SR_6_frames_checkpoint, VRT_SR_6_frames_checkpoint_img_sz_160, VRT_deblur_6_frames_checkpoint
...
# model_denoise_path = '/raid/Pytorch_Checkpoints/2022-07-05/Model_New_Checkpoints/VRT_denoise_third_eye_train.py' \
#                 '/VRT_denoise_third_eye_train.py_TEST1_Step54375.tar'
...
# model_denoise_path = '/raid/Pytorch_Checkpoints/2022-08-22/Model_New_Checkpoints/VRT_denoise_deblur_ranges_NU_harder.py' \
#                 '/VRT_denoise_deblur_ranges_NU_harder.py_TEST1_Step8700.tar'
# model_denoise_path = '/raid/Pytorch_Checkpoints/2022-08-22/Model_New_Checkpoints/VRT_denoise_deblur_ranges_NU.py' \
#                 '/VRT_denoise_deblur_ranges_NU.py_TEST1_Step9000.tar'
# model_denoise_path = '/raid/Pytorch_Checkpoints/2022-08-24/Model_New_Checkpoints/VRT_denoise_deblur_ranges_NU.py_NU_ranges' \
#                 '/VRT_denoise_deblur_ranges_NU.py_NU_ranges_TEST1_Step42150.tar'

# model_denoise_path = '/raid/Pytorch_Checkpoints/2022-08-24/Model_New_Checkpoints/VRT_denoise_deblur_ranges_NU_harder.py_NU_ranges' \
#                 '/VRT_denoise_deblur_ranges_NU_harder.py_NU_ranges_TEST1_Step42150.tar'
...
Train_Images_Folder = osp.join(datasets_main_folder, 'vrt_third/sr2_31_7')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'vrt_third/sr2_31_7')
...
IO_dict.test_args = TestArgs(tile=[36,192,192], nonblind_denoising=False, scale=1)
...
IO_dict.Corrupted_string_pattern_to_search = '*Network_Outputs*'
IO_dict.GT_string_pattern_to_search = '*GT*'
