...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_pelicanD_denoise'
...
IO_dict.test_args = TestArgs(tile=[12,192,192], nonblind_denoising=True, scale=1)
...
IO_dict_test.number_of_image_frames_to_generate = 24 * 3
IO_dict_test.number_of_images_per_video_to_load = 24 * 3
#######################################################################################################################################
