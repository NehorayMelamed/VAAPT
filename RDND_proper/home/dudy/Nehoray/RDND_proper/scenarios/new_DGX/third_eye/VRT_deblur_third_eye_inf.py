...
### Import Models: ###
from KAIR_light.models.vrt_models import VRT_deblur_6_frames_checkpoint
...
model_deblur_path = '/raid/Pytorch_Checkpoints/2022-07-11/Model_New_Checkpoints/VRT_deblur_tranin_drones_no_noise.py' \
                    '/VRT_deblur_tranin_drones_no_noise.py_TEST1_Step23400.tar'
...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) +'3'
...
IO_dict.test_args = TestArgs(tile=[36,192,192], nonblind_denoising=False)
IO_dict.no_GT = False
### Loading Images: ###
#(1). Folder names:
#(1.1). Root Folder:
...
IO_dict.PPP = [50, 100] #[2, 10]  # Photons per Pixel.
### Noise Addition: ###
temp_factor = 70/255
...
IO_dict.transforms_dict.shift_size = 16
