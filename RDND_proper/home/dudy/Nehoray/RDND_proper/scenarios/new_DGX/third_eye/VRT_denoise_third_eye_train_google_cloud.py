import sys
sys.path.extend(['/home/omer/rdnd', '/home/omer/rdnd'])
...
### Paths: ###
#(1). General Paths:
home_path = '/home/omer' #Path.home()
base_path = home_path
project_path = osp.join(base_path, 'rdnd')
today_date = datetime.today().strftime('%Y-%m-%d')
inference_path_master = osp.join('/home/omer/Pytorch_Checkpoints', today_date)
...
datasets_main_folder = '/home/omer/datasets'
...
#(2). Train Images:
Train_Images_Folder = osp.join(datasets_main_folder, 'drones')
...
Test_Images_Folder = osp.join(datasets_main_folder, 'drones')
...
IO_dict.PPP = 50 #[2, 10]  # Photons per Pixel.
### Noise Addition: ###
temp_factor = 70/255
...
#####################################################################################################################################################################
### Model Itself: ###
model = VRT_denoise_6_frames_checkpoint(True, checkpoint_path=model_denoise_path, train_device=train_devices[0],
