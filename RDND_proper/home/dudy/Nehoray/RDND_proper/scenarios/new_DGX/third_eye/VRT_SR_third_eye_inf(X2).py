...
Train_dict.Network_checkpoint_prefix = os.path.basename(__file__) + '_SR_Drones'
...
IO_dict.test_args = TestArgs(tile=[60,160,160], nonblind_denoising=False, scale=4)
IO_dict.no_GT = True
...
IO_dict_test.number_of_image_frames_to_generate = 36
IO_dict_test.number_of_images_per_video_to_load = 36
#######################################################################################################################################
