...
from mmedit_models.mmedit_models import FTVSR_base
...
model_sr_path = osp.join(base_path, 'rdnd/FTVSR_REDS.pth')
# model_sr_path = osp.join(base_path, 'rdnd/FTVSR_Vimeo90K.pth')
...
IO_dict.Corrupted_string_pattern_to_search = '*crf_35*'
...
#####################################################################################################################################################################
### Model Itself: ###
model = FTVSR_base(True, checkpoint_path=model_sr_path, train_device=train_devices[0])
