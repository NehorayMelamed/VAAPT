...
IO_dict.row_readout_noise_sigma = (0,sigma)
IO_dict.col_readout_noise_sigma = (0,sigma)
### Post Loading Stuff: ###
...
fft_function_num = 2
p = 0.5
Loss_object = RapidBase.TrainingCore.losses.Loss_FFT_VRT(fft_function_num=fft_function_num , p=p) #FFT Loss
