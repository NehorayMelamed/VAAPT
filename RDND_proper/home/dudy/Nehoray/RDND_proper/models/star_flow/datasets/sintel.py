...
class SintelTrainingCleanTrain(_Sintel):
    def __init__(self, args, root, photometric_augmentations=True, reverse=False):
...
class SintelTrainingCleanValid(_Sintel):
    def __init__(self, args, root, photometric_augmentations=False, reverse=False):
        dir_root = os.path.join(root, "training")
