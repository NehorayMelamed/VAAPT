...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=  # noqa: E251
        '/home/mafat/PycharmProjects/IMOD/models/GitHub/BasicSR/experiments/pretrained_models/EDVR/EDVR_L_x4_SR_REDS_official-9f5f5039.pth'  # noqa: E501
    )
    parser.add_argument(
        '--folder',
        type=str,
    ...
    model = EDVR(
        ...
        num_extract_block=5, num_reconstruct_block=40, with_predeblur=False, with_tsa=True, hr_in=False)
