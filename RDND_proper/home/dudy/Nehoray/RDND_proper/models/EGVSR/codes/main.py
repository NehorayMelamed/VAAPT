...
import torch
from RDND_proper.models.EGVSR.codes.data import create_dataloader, prepare_data
from RDND_proper.models.EGVSR.codes.models import define_model
from RDND_proper.models.EGVSR.codes.models.networks import define_generator
from RDND_proper.models.EGVSR.codes.metrics.metric_calculator import MetricCalculator
from RDND_proper.models.EGVSR.codes.metrics.model_summary import register, profile_model
from RDND_proper.models.EGVSR.codes.utils import base_utils, data_utils
...
###
args = EasyDict()
args.exp_dir = r'/home/mafat/PycharmProjects/IMOD/models/EGVSR/experiments_BD/EGVSR/001'
args.mode = 'test'
args.model = 'FRVSR'  #'TecoGAN' , 'FRVSR'
args.opt = r'test.yml'
args.gpu_id = 0
args.lr_size = '3x256x256'
args.test_speed = 'store_true'  # ha?
