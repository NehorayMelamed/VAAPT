...
parser.add_argument('--input_dir', default='./datasets/fivek_sample_images/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/enhancement/fivek/', type=str, help='Directory for results')
parser.add_argument('--weights', default='./pretrained_models/enhancement/model_fivek.pth', type=str, help='Path to weights')
