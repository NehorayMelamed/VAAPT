...
def define_G(opt):
    ...
    # ----------------------------------------
    if net_type == 'dncnn':
        from RDND_proper.models.network_dncnn import DnCNN as net
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_dncnn import FDnCNN as net
        netG = net(in_nc=opt_net['in_nc'],
                   out_nc=opt_net['out_nc'],
                   nc=opt_net['nc'],
                   nb=opt_net['nb'],  # total number of conv layers
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_ffdnet import FFDNet as net
        netG = net(in_nc=opt_net['in_nc'],
                   out_nc=opt_net['out_nc'],
                   nc=opt_net['nc'],
                   nb=opt_net['nb'],
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_srmd import SRMD as net
        netG = net(in_nc=opt_net['in_nc'],
                   out_nc=opt_net['out_nc'],
                   nc=opt_net['nc'],
                   nb=opt_net['nb'],
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_dpsr import MSRResNet_prior as net
        netG = net(in_nc=opt_net['in_nc'],
                   out_nc=opt_net['out_nc'],
                   nc=opt_net['nc'],
                   nb=opt_net['nb'],
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_msrresnet import MSRResNet0 as net
        netG = net(in_nc=opt_net['in_nc'],
                   out_nc=opt_net['out_nc'],
                   nc=opt_net['nc'],
                   nb=opt_net['nb'],
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_msrresnet import MSRResNet1 as net
        netG = net(in_nc=opt_net['in_nc'],
                   out_nc=opt_net['out_nc'],
                   nc=opt_net['nc'],
                   nb=opt_net['nb'],
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_rrdb import RRDB as net
        netG = net(in_nc=opt_net['in_nc'],
                   out_nc=opt_net['out_nc'],
                   nc=opt_net['nc'],
                   nb=opt_net['nb'],
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_rrdbnet import RRDBNet as net
        netG = net(in_nc=opt_net['in_nc'],
                   out_nc=opt_net['out_nc'],
                   nf=opt_net['nf'],
                   nb=opt_net['nb'],
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_imdn import IMDN as net
        netG = net(in_nc=opt_net['in_nc'],
                   out_nc=opt_net['out_nc'],
                   nc=opt_net['nc'],
                   nb=opt_net['nb'],
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_usrnet import USRNet as net
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_unet import UNetRes as net
        netG = net(in_nc=opt_net['in_nc'],
                   out_nc=opt_net['out_nc'],
                   nc=opt_net['nc'],
                   nb=opt_net['nb'],
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_swinir import SwinIR as net
...
def define_D(opt):
    ...
    if net_type == 'discriminator_vgg_96':
        from RDND_proper.models.network_discriminator import Discriminator_VGG_96 as discriminator
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_discriminator import Discriminator_VGG_128 as discriminator
        netD = discriminator(in_nc=opt_net['in_nc'],
                             base_nc=opt_net['base_nc'],
                             ac_type=opt_net['act_mode'])
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_discriminator import Discriminator_VGG_192 as discriminator
        netD = discriminator(in_nc=opt_net['in_nc'],
                             base_nc=opt_net['base_nc'],
                             ac_type=opt_net['act_mode'])
    ...
    # ----------------------------------------
        ...
        from RDND_proper.models.network_discriminator import Discriminator_VGG_128_SN as discriminator
        netD = discriminator()

    elif net_type == 'discriminator_patchgan':
        from RDND_proper.models.network_discriminator import Discriminator_PatchGAN as discriminator
        ...
        from RDND_proper.models.network_discriminator import Discriminator_UNet as discriminator
        netD = discriminator(input_nc=opt_net['in_nc'],
                             ndf=opt_net['base_nc'])
...
def define_F(opt, use_bn=False):
    ...
    from RDND_proper.models.network_feature import VGGFeatureExtractor
