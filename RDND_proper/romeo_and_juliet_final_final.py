...
sys.path.append("/home/simteam-j/daheng_recording/pipelines/hist_equalization")
...
def plot_running(number_of_samples_to_display=256*4, title="", mini_batch_size=3, number_of_samples_to_pause=10):
    ### Default parameters: ###
    ...
    while True:
        ...
        y_batch = filtered_batch.squeeze()
        print(batch_index)
        batch_index += 1
        # batch_index += 1
        ### get current batch: ###
...
plot_running(title="romeo and juliet")