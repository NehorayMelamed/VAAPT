...
# import kornia
def scale_array_clahe(input_tensor, flag_stretch_histogram_first=True, quantiles=(0.01, 0.99), flag_return_quantile=False, grid_size=(8,8), clip_limit=40):
    ...
    if type(input_tensor) == torch.Tensor:
        ...
        scaled_array = kornia.enhance.equalize_clahe(scaled_array, clip_limit=clip_limit, grid_size=grid_size)
