...
def configure_logging():
    ...
    Filehandler = logging.FileHandler("C:/Users\dkarl\Desktop\GoogleImagesDownload\log.txt")  # Path to your LOG FILE.
...
def main():
    ...
    parser.add_argument('-d', '--directory', default='C:/Users\dkarl\Desktop\GoogleImagesDownload', type=str,
                        help='save directory')
